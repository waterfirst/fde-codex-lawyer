...
일요일 2시간 동안 변호사 친구에게 **Codex로 일하는 법**을 알려주고,  
**법제처(law.go.kr) MCP**를 연결해 개인파산/개인회생 업무용 루틴을 함께 만든다.
...
1. Codex에게 사건 자료 정리 지시하기
2. 법제처 MCP로 법령 근거 확인하기
3. 개인파산/개인회생 사건 1건의 1차 검토 패킷 만들기
4. 누락자료·쟁점후보·변호사 확인질문 뽑기
5. 결과물을 GitHub/HTML로 남겨 다음 사건에 재사용하기
...
| 0:15–0:30 | 환경연결 | Codex·법제처 MCP 연결 확인 |
| 0:30–0:50 | 첫 성공 | 법령 Q&A 1개 성공 |
| 0:50–1:20 | 사건 루틴 | 개인파산/회생 Intake 루틴 설계 |
| 1:20–1:45 | 토탈 패킷 | 요약·쟁점·증빙·질문 5종 산출물 |
