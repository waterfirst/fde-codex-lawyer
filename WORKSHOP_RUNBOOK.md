...
핵심은 코딩 교육이 아니다.  
**문제정의 → Codex 지시 → 법제처 MCP 근거확인 → 사건 검토 패킷 생성 → GitHub 핸드오프**를 경험시키는 것이다.
...
변호사가 “아, 검색과 초안은 AI에게 시킬 수 있구나”를 느끼게 한다.
...
2. 질문 하나 입력
3. 조문 인용 여부 확인
4. 답변 끝에 “초안이며 변호사 검토 필요”가 붙는지 확인
...
`prompts/01_case_intake_prompt.md` 사용
