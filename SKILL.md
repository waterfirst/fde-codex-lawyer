...
- Python local reader: 변호사 노트북 안에서 문서 텍스트 추출, 개인정보 마스킹, 날짜/금액/문서목록 구조화
- Codex: 마스킹 결과를 바탕으로 폴더/파일/CSV/HTML/반복 루틴 생성
- 법제처 MCP: 법령 근거 확인
- Claude/GPT: 최종 구조화, 위험표현 제거, 오케스트레이션 판단
- 변호사: 최종 법률 판단
- NotebookLM/Gemini: 익명 샘플 또는 완전 마스킹 자료에 한한 선택 보조 도구
